...
from faixas.views import FaixasList
from restaurante.views import RestauranteList
...
urlpatterns = [
    ...
    path('faixas/' , FaixasList.as_view(), name='faixas_list'),
    path('restaurante/' , RestauranteList.as_view(), name='restaurante_list')
